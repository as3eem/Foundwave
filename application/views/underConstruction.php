    ...
    <div class="row">
        <div class="col-md-6">
            <div class="error-template">
                ...
                <div>
                    <p>
                        Here we will build <strong>STRONG POLICE NETWORK COMMUNITY</strong> where police community of a particular area will be able to communicate with another area without any barriers.
                    This network will help different items or stuffs lost somewhere easily available to right person or area.</p>
                    <p>
                        — Foundwave Team</p>
                </div>
                <div class="error-actions">
                    <a href="<?=base_url()?>" style="margin-top: 10px;" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-home">
                    </span>Take Me Home </a>
                </div>
            </div>
        </div>
